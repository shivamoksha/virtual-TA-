    ...
    try:
        ...
        try:
            ...
            if not relevant_results:
                logger.info("No relevant results found, returning empty response")
                return QueryResponse(answer="I don't have enough information to answer this question.", links=[])
